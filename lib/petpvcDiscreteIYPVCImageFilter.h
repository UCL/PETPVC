/*
   petpvcDiscreteIYPVCImageFilter.h
...
#ifndef __PETPVCDISCRETEIYIMAGEFILTER_H
#define __PETPVCDISCRETEIYIMAGEFILTER_H
...
class DiscreteIYPVCImageFilter:public ImageToImageFilter< TInputImage, TInputImage >
{
public:
    /** Standard class typedefs. */
    typedef DiscreteIYPVCImageFilter             Self;
...
private:
    DiscreteIYPVCImageFilter(const Self &); //purposely not implemented
...
#include "petpvcDiscreteIYPVCImageFilter.txx"
#endif


#endif // __PETPVCDISCRETEIYIMAGEFILTER_H
