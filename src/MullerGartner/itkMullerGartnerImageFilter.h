...
public:
  ...
  void SetPSF(VectorType dSigma2) {this->m_dVariance =  dSigma2; };
  void SetQuietMode(bool bQuiet) {this->m_bQuietMode = bQuiet;};
  void SetWM(double fWM) {this->m_fGivenWM = fWM;};
...
#include "itkMullerGartnerImageFilter.txx"
#endif
