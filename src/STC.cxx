...
int main(int argc, char *argv[])
{
    ...
    command.SetDescription(
        "Performs Single Target Correction (STC) partial volume correction");
    ...
    stcFilter->SetIterations( nNumOfIters );
    ...
    try {
        ...
        std::cerr << "[Error]\tfailure applying STC on: " << sPETFileName
                  << "\n" << err
                  << std::endl;
        return EXIT_FAILURE;
    }
    ...
    petWriter->SetInput( stcFilter->GetOutput() );
